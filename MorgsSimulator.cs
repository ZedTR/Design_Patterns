...
{
    class MorgsSimulator:Simulator,IWeather
    {
        public MorgsSimulator(Environment environment) : base(environment)
        {
        }
        ...
        protected override void Type(Entity e)
        {
           Morgs morgs = e as Morgs;
            if (morgs != null)
            {
                ...
                {
                    case "A":
                        Console.WriteLine(" morg type is:" + morgs.Name);
                        break;
                    case "B":
                        Console.WriteLine(" morg type is:" + morgs.Name);
                        break;
        ...
        public void WeatherCondition(string input)
        {
            

            string rain = " its raining";
            string snow = " its snowing";
            string fog = " its fogging";

            switch (input)
            {
                case "24":
                    Console.WriteLine(" it's" + rain);
                    break;
                case"7":
                    Console.WriteLine("It's"+ snow);
                    break;
                case"11":
                    Console.WriteLine("It's"+ fog);
                    break;
                default:
                    Console.WriteLine("It's clear weather");
                    break;
            }
