...
namespace CST276_Assign_3
{
    ...
    {
        public MechanicalSimulator(Environment environment) : base(environment)
        {
        }
        ...
        protected override void Type(Entity e)
        {
            ...
            if (morgs != null)
            {
                ...
                {
                    case "A":
                        Console.WriteLine("mechanical morg type is:" + morgs.Name);
                        break;
                    case "B":
                        Console.WriteLine("mechanical morg type is:" + morgs.Name);
                        break;
        ...
        protected override void Hunt(Entity e)
        {
            ...
            if (morgs != null)
            {
                ...
                {
                    case "Absorbs B C":
                        Console.WriteLine(morgs.Name + " have decimated Type B and C");
                        break;
                    case "Envelops A":
                        Console.WriteLine(morgs.Name + " have compressed Type A");
                        break;
                    case "Envelops A B":
                        Console.WriteLine(morgs.Name + " have compressed Type A and B");
                        break;
                    case "Absorbs C":
                        Console.WriteLine(morgs.Name + " have decimated Type C");
                        break;
                    default:
                        Console.WriteLine(morgs.Name + " is idle!!!");
                        break;
                }
            }
        }
        ...
        protected override void Move(Entity e)
        {
            ...
            if (morgs != null)
            {
                ...
                {
                    case "Paddles":
                        Console.WriteLine(morgs.Name + " is Paddling");
                        break;
                    case "Oozes":
                        Console.WriteLine(morgs.Name + " is Oozing");
                        break;
                    default:
